        ...
        public void insertpackages()
        {
            try
            {
                ...
                List<Packages> lstpackages = new List<Packages>()
                {
                    ...
                    new Packages
                    {
                        PName="Kashmir Holiday with Airfare",//
                        PPrice=12000,
                    ...
                    new Packages
                    {
                        PName="Local Sight Seeing Tour Package",//
                        PPrice=18000,
                    ...
                    new Packages
                    {
                        PName="Boracay Package",
                        PPrice=60000,
                        PDestination="Philliphines",
                        PNoofdays=4,
                        PStartdate=DateTime.Parse("01-12-2022"),
                        PEnddate=DateTime.Parse("01-01-2023"),
                        PcatId=3 // for rainy category
                    },
                    new Packages
                    {
                        PName="Centra Grand Beach",
                        PPrice=50000,
                        PDestination="Thailand",
                        PNoofdays=4,
                        PStartdate=DateTime.Parse("01-12-2022"),
                        PEnddate=DateTime.Parse("01-01-2023"),
                        PcatId=3 // for rainy category
